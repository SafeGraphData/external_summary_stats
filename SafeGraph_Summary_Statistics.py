...
st.markdown(
    """
    SafeGraph produces data on physical places from retail stores and warehouses to hospitals and parks. SafeGraph’s POI (point of interest) database covers over 47 million places in over 190 countries. Companies like Esri, Domino’s, Mapbox, and Clear Channel rely on SafeGraph data to power their applications, platforms, and services.
    ### Want to learn more?
